    ...
    <body class="home layout_changer">
        ...
        <header class="main-header header-style-two">
            ...
            <div class="container clearfix">
                <div class="header-lower-style-two color1_bg">
                    <div class="row">
                        <div
                            class="col-md-12 col-sm-12 col-xs-12 col-md-offset-1"
                            style="text-align: center"
                        >
                            <div class="drugastrana">
                                <div class="menu-bar">
                                    <nav class="main-menu">
                                                ...
                                                <ul class="navigation clearfix">
                                                    ...
                                                    <li class="logo-box">
                                                        <a
                                                            ...
                                                            class="logo"
                                                            ><img
                                                                src="images/logo/logo ristajling.png"
                                                                alt=""
                                                        /></a>
                                                    </li>
                                                    <li>
        ...
        <section class="sidber-page-container rooms-section room-details">
            <div class="container">
                <div class="row">
                    <div
                        class="col-md-9 col-sm-12 col-xs-12 room-details-content"
                    >
                    ...
                    <div
                        class="col-md-3 col-sm-6 col-xs-12 room-sidber-content"
                    >
                                    ...
                                    <div class="row">
                                        ...
                                        >
                                            <div class="single-input">
                                                ...
                                                <select
                                                    ...
                                                    form="reservation-form" name="payment" id="payment"
                                                >
                                        ...
                                        >
                                            <div class="single-input">
                                                ...
                                                <select
                                                    class="custom-select-box"
                                                    form="reservation-form" name="room" id="room"
                                                >
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="footer-bottom-content">
                    <div class="copyright">
                        Copyright © 2022 Ribarski Konaci. All Rights Reserved.
                        Designed by
                        <a href="https://resivoje.com/"
                            ><u><strong>RešivoJe</strong></u></a
                        >
                    </div>
                </div>
            </div>
        ...
        <script
            type="text/javascript"
            src="js/revolution.extension.kenburn.min.js"
        ></script>
        <script
            type="text/javascript"
        ...
        <script
            type="text/javascript"
            src="js/revolution.extension.parallax.min.js"
        ></script>
        <script
            type="text/javascript"
            src="js/revolution.extension.migration.min.js"
        ></script>
